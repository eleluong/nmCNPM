...
const User = () => {
    ...
    return (
        ...
        <nav class="list-group" id='nav'>
            <a name="info" class="list-group-item with-badge active" href="/UserInfo"><i class="fa fa-user"></i>Thông tin cá nhân<span class="badge badge-primary badge-pill"></span></a>
            <a name="password" class="list-group-item with-badge " href="/UserPassword"><i class="fa "></i>Đổi mật khẩu<span class="badge badge-primary badge-pill"></span></a>
            ...
            <a name="point" class="list-group-item with-badge" href="/UserPoint"><i class="fa fa-tag"></i>Điểm của tôi<span class="badge badge-primary badge-pill"></span></a>
        </nav>
    </div>
    </div>
    )
